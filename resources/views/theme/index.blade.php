                ...
                <div class="owl-carousel owl-theme blog-slider">
                    ...
                    <div class="card blog__slide text-center">
                        <div class="blog__slide__img">
                            <img class="card-img rounded-0" height="150" src="{{ asset('storage') }}/blogs/{{$blog->image}}"
                                alt="">
                        </div>
                        <div class="blog__slide__content">
                            <a class="blog__slide__label" href="{{ route('theme.category',['id'=>
                            $blog->category->id]) }}">{{$blog->category->name}}</a>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="w-10 img-fluid" width="100%" height="100%" src="{{ asset('storage') }}/blogs/{{$blog->image}}" alt="">
                                <ul class="thumb-info">
